        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-500 dark:text-zinc-500 text-[10px] max-w-xs leading-tight mb-2">
              ...
              <h5 className="text-black dark:text-white">Founded </h5> by <h4 className="text-black dark:text-white">Haris Shafi,</h4> driven by a vision to make invoicing effortless for freelancers and small businesses everywhere
            </p>
